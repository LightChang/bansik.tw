...
- **各聯評中心自家網頁仍沒逐站解析**，卡在拿不到網址：名錄裡只有 9/90 家填了官網。衛生局頁雖然附了連結，但多是 reurl／shorturl 短網址，HEAD 展不開（reurl 回 200 但不給 Location、shorturl.at 直接 403），要展開得逐一 GET 回內容再剖，成本高於效益。
